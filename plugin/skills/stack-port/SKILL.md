...
name: stack-port
description: >-
  Port a working legacy project onto a new stack while keeping all behaviour.
  Inventory the old app first, then migrate in small reversible steps. Use when
  rewriting, migrating frameworks, or porting between stacks.
---
