...
description: >-
  Safely change a legacy system: map blast radius via .gitmir/model/, scope
  adjacent behaviour, ship in small reversible steps. Use for refactors,
  bugfixes, or features on large coupled codebases.
---
