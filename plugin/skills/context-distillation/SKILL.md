...
description: >-
  Distill messy input into a small high-signal brief written to
  .gitmir/brief.json. Use when the user pastes long notes, meeting transcripts,
  tickets, or asks to compress context for the model.
---
