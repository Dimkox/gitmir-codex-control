...
name: task-planner
description: >-
  Break a goal into small independently-runnable tasks as markdown files under
  tasks/todo/, each with a ## Verify section derived from .gitmir/model/ blast
  radius. Use when the user asks to plan work, create tasks, queue a feature,
  or split a goal into steps for task-runner.
---
